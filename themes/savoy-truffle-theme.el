 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'savoy-truffle
	...
	`(cursor ((,class (:background ,fg1))))
        ...
        `(mode-line ((,class (:box (:line-width 1 :color fg2) :bold t :foreground ,fg4 :background ,bg2))))
        `(mode-line-inactive ((,class (:box (:line-width 1 :color fg2) :foreground ,comment :background ,bg1 :weight normal))))
        `(mode-line-buffer-id ((,class (:bold t :foreground ,func :background nil))))
	`(mode-line-highlight ((,class (:foreground ,keyword :box nil :weight bold))))
        `(mode-line-emphasis ((,class (:foreground ,fg1))))
	`(line-number ((,class (:background ,bg2 :foreground, fg1))))
